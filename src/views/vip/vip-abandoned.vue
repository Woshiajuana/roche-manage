<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="是否激活" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.IsAtMember == 1?'是':'否' }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="已训练次数" width="100px" align="center">
       ...
       <el-table-column label="放弃时间" class-name="status-col" width="160" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.GiveUpTimeStr }}</span>
        </template>
      </el-table-column>
      <el-table-column label="操作放弃人" class-name="status-col" width="160" align="center">
        <template slot-scope="scope">
         <span>{{ scope.row.GiveUpUserID }}</span>
        </template>
      </el-table-column>
   ...
   <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="放弃时间">
          <el-input v-model="temp.GiveUpTimeStr" placeholder="" readonly/>
        </el-form-item>
        <el-form-item label="操作放弃人">
          <el-input value='temp.GiveUpUserID' readonly/>
        </el-form-item>
      </el-form>
