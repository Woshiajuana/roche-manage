  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="手机号" width="110px" align="center">
       ...
       <el-table-column label="导入日期" class-name="status-col" min-width="160" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.ImportTimeStr }}</span>
        </template>
      </el-table-column>
      <el-table-column label="首访日期" class-name="status-col" min-width="160" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.FirstVisitTimeStr }}</span>
        </template>
      </el-table-column>
       <el-table-column label="完成训练时间" class-name="status-col" min-width="160" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.LastPlanCompleteTime }}</span>
        </template>
      </el-table-column>
      <el-table-column label="管家账号" class-name="status-col" min-width="100" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="管家账号">
          <el-input value='temp.FirstVisitUserID' readonly/>
        </el-form-item>
      </el-form>
