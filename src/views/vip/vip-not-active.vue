<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="使用者姓名" align="center">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="使用者手机号" prop="Mobile">
          <el-input v-model="temp.Mobile" placeholder="" />
        </el-form-item>
        <el-form-item label="使用者微信号" prop="WxNo">
          <el-input v-model="temp.WxNo" placeholder="" />
        </el-form-item>
        ...
        <el-form-item label="购买人姓名" prop="BuyUser">
          <el-input v-model="temp.BuyUser" placeholder="" />
        </el-form-item>
        <el-form-item label="购买人电话" prop="BuyUserMobile">
          <el-input v-model="temp.BuyUserMobile" placeholder="" />
        </el-form-item>
        <el-form-item label="购买人微信" prop="BuyWxNo">
          <el-input v-model="temp.BuyWxNo" placeholder="" />
        </el-form-item>
         <el-form-item label="拒绝次数" prop="RefuseTel">
          <el-input v-model="temp.RefuseTel" placeholder="" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        BuyWxNo: [{ required: true, message: '请输入购买人微信号', trigger: 'change' }],
        RefuseTel: [{ required: true, message: '请输入拒绝次数', trigger: 'change' }],
      },
