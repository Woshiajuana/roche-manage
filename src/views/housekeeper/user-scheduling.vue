            ...
            <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm">
                ...
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="血压："  >
                        <el-input v-model="ruleForm.BloodPressure" placeholder="请输入血压" :disabled="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="胆固醇："  >
                        <el-input v-model="ruleForm.Cholesterol" placeholder="请输入胆固醇" :disabled="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="甘油三酯："  >
                        <el-input v-model="ruleForm.Triglyceride" placeholder="请输入甘油三酯" :disabled="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="高密度脂蛋白："  >
                        <el-input v-model="ruleForm.HighDensity" placeholder="请输入高密度脂蛋白" :disabled="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="低密度脂蛋白："  >
                        <el-input v-model="ruleForm.LowDensity" placeholder="请输入低密度脂蛋白" :disabled="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="尿酸："  >
                        <el-input v-model="ruleForm.UricAcid" placeholder="请输入尿酸" :disabled="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
