    ...
    <div class="form-style">
        <el-row :gutter="20">
            ...
            <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm">
                ...
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="糖尿病类型：" prop="SugarType">
                        <el-input v-model="ruleForm.SugarTypeStr" placeholder="糖尿病类型" :readonly="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="确诊时间：" prop="DiagnosisTime">
                        <el-date-picker v-model="ruleForm.DiagnosisTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择时间" style="width:100%;" :readonly="isView" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12" :lg="24" :xl="24" />
                <el-col :xs="24" :md="12" :lg="8" :xl="6">
                    <el-form-item label="当前治疗方案：" prop="TreatmentPlan">
                        <el-input v-model="ruleForm.TreatmentPlanStr" placeholder="" :readonly="isView" />
                    </el-form-item>
            ...
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="备注" align="center">
                        <template slot-scope="scope">
                            <el-input v-model="scope.row.Hour" class="filter-item" placeholder="请输入备注" style="width:100%;" :disabled="true"></el-input>
                        </template>
                    </el-table-column>
                ...
                <template>
                    <el-tabs v-model="activeName" class="tab-page-div" @tab-click="handleClick">
                        ...
                        <el-tab-pane label="任务报告" name="second">
                            <report-form ref="report" v-if='tabsIndex == 1' title="本周" tab_type="0" :temp="week_queryData" ></report-form>
                        </el-tab-pane>
                        <el-tab-pane label="控糖方案" name="third">
                            <iframe width="100%" height="500px" :src="'https://jkys-wechat.91jkys.com/user/third/login?pin=' + $route.query.UserId +'&accessId=roche&page=HEALTH_MANAGE'" frameborder="0"></iframe>
                        </el-tab-pane>
                    </el-tabs>
                </template>
            </el-col>
            ...
            <el-col :span="24">
                ...
                <task-do :rowData='rowData' @refreshReport="handleRefreshReport"></task-do>
            </el-col>
